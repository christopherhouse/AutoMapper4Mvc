...
using ThirteenDaysAWeek.AutoMapper4Mvc.ActionFilters.Mvc;

namespace ThirteenDaysAWeek.AutoMapper4Mvc.Tests.ActionFilters.Mvc
{
    [TestClass()]
    public class AutoMapAttributeTests
    {
        ...
        public void Constructor_Should_Throw_ArgumemtNullException_If_SourceType_Is_Null()
        {
            // Arrange
        ...
        [TestMethod()]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Constructor_Should_Throw_ArgumemtNullException_If_DestinationType_Is_Null()
        {
            // Arrange
